...
import 'package:task_app/src/modules/details/widgets/doing_list.dart';
import 'package:task_app/src/modules/details/widgets/done_list.dart';
                    ...
                    suffixIcon: IconButton(
                      onPressed: () {
                        if (homeCtrl.formKey.currentState!.validate()) {
                          ...
                          if (success) {
                            EasyLoading.showSuccess('Task item is added');
                          } else {
